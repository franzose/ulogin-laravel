...
class UloginLaravelCreateUloginProfilesTable extends Migration {
	...
	public function up()
	{
        Schema::create(Config::get('ulogin-laravel::config.db_table'), function(Blueprint $table){
	...
	{
        Schema::drop(Config::get('ulogin-laravel::config.db_table'));
	}
